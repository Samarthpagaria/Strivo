...
const MenuItem = ({ children, label, onClick, isExpanded }) => (
  <div className="relative group ">
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-300 focus:bg-gray-400 focus:outline-none transition-colors font-medium text-[15px] text-neutral-900 text-sm"
    >
...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`bg-gray-200 fixed shadow-md h-[80vh] overflow-hidden rounded-xl py-2 transition-all duration-300 ${
