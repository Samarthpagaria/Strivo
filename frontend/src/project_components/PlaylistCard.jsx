...
import { DeletePlaylistModal, EditPlaylistModal } from "./PlaylistModals";
    ...
    <>
      ...
      >
        ...
        <img
          src={
            thumbnail ||
            "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&h=1200&fit=crop"
          }
          alt={title}
        ...
        <div className="absolute left-0 right-0 top-0 flex items-start justify-between p-4">
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            >
              {/* Main Actions Button (Tiny Circular Dot) */}
