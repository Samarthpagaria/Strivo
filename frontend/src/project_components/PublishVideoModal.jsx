  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[9999] flex items-center justify-center p-4 backdrop-blur-lg">
      <motion.div
        ...
        className="bg-white border border-neutral-200 rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] w-full max-w-3xl p-4 sm:p-8 relative overflow-hidden flex flex-col max-h-[90vh]"
      >
        <button
          onClick={onClose}
          className="absolute top-6 right-6 text-neutral-400 hover:text-neutral-900 transition-colors z-20 p-2 hover:bg-neutral-100 rounded-full"
        >
          <X className="w-5 h-5" />
        </button>

        <div className="relative z-10 mb-8 shrink-0">
          <h2 className="text-2xl md:text-3xl font-black text-neutral-900 font-satoshi tracking-tight mb-2">
            Publish new content
          </h2>
